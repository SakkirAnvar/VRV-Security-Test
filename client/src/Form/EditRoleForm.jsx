...
const EditRoleFormModal = ({ roleId, closeModal,closeModelWithoutSave }) => {
  const {
    data: role,
    error: fetchError,
    refetch,
  } = useGetRoleByIdQuery(roleId);
  const [updateRole,{isLoading:editing}] = useUpdateRoleMutation();
                              ...
                              >
                                <label className="relative inline-flex items-center cursor-pointer">
                                  <input
                                    ...
                                    checked={
                                      formData?.permissions[menu][accessType]
                                    }
                                    onChange={handleChange}
