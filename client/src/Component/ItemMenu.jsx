...
import { MdDashboard, MdTag, MdHelpOutline, MdCategory } from "react-icons/md";
...
function ItemMenu({ closeModal }) {
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-white rounded-lg shadow-lg overflow-y-auto max-h-[90vh] w-full md:max-w-2xl animate-fadeIn scale-105 duration-500 ease-in-out"
